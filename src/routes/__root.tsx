          ...
          <div className="flex items-center justify-between relative lg:mx-15 lg:my-5 border-b p-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <nav className="hidden md:flex gap-4 text-gray-600">
                <Link to="/collections" className="[&.active]:font-bold">Collections</Link>
                <Link to="/men" className="[&.active]:font-bold">Men</Link>
                <Link to="/women" className="[&.active]:font-bold">Women</Link>
            ...
            <div className="flex items-center gap-6">
              ...
              <img src="/images/image-avatar.png" alt="profile image"  className="w-10 h-10"/>
            </div>
          </div>

          {/* Mobile menu dropdown */}
          <div
          className={`fixed top-0 left-0 h-full w-2/3 bg-white shadow-lg p-6 transform transition-transform duration-300 md:hidden ${
